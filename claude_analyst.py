...
direction (LONG when smart money is net buying, SHORT when net selling).

Reason about whether opening that position in that direction is reasonable, then \
return a verdict.

Be skeptical and default to "skip":
- Smart-money net inflow is a weak, noisy signal, not a guarantee.
- You have NO real-time data, news, or order-book context — acknowledge that uncertainty.
- Only choose "trade" when the signal is strong and you can give a concrete reason.
